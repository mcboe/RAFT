...
def run_example(plot_flag = False):
    ...
    with open('C:\\Users\\mcboe\\OneDrive - Delft University of Technology\\Documenten\\Master ODE\\Afstuderen\\Github\\RAFT\\examples\\VolturnUS-S_example.yaml') as file:
